...
class Enemy {
    constructor(app, x, y, height, width, range, img, canJump = false, movementType = 'forward', gravity = true) {
        ...
        this.jumpForce = Math.random() * (-100) + (-30);
        this.isJumping = false;
...
class Brick {// also can be used for ground
    constructor(app, x, y, height, width, breakable = false, afterTime = 0) {
        this.sprite = new PIXI.Graphics();
...
const levels = {
    1:{
        ...
        platforms: [
            ...
            new Platform(app, 0, app.screen.height-50, app.screen.width*2)
        ...
        enemies: [
            ...
            new Enemy(app, 700, 100, 50, 50, 0, 'e1.png', true), // This enemy can jump
        ...
        bricks: [
            new Brick(app, 500, 400, 20, 100, false),
            new Brick(app, 900, 300, 20, 100, true, 2000)
        ],
